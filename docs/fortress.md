...
of client release 0.13.0; a versioned
`signal-fish-client = "0.13.0"` dependency is sufficient.
...
run against server 0.9.0; a second clean job pins server 0.4.0 as the explicit
