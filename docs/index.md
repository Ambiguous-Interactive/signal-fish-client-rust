...
!!! note "Release status"
    **0.14.0** is the current crates.io release and supports Rust **1.87.0** or
    newer. This site follows unreleased `main`; use the [0.14.0 API
    docs](https://docs.rs/signal-fish-client/0.14.0/) for the published surface.
