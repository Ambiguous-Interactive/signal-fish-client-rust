...
!!! note "Published release and main"
    **0.13.0** is the current crates.io release. This guide follows unreleased
    ...
    says which release added them. Use the [0.13.0
    docs.rs pages](https://docs.rs/signal-fish-client/0.13.0/) with the versioned
