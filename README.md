...
The published `0.14.0` crate is the stable release. This branch also documents
unreleased changes ahead of the next release. Use the [0.14.0 API
docs](https://docs.rs/signal-fish-client/0.14.0/) for the published surface, or
see the
