...
description: Decide whether a change needs a changelog entry in Signal Fish. Use when classifying public API, behavior, protocol, dependency, environment, test, CI, or documentation changes.
---
