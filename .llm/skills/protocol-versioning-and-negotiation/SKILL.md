...
description: Preserve Signal Fish protocol compatibility and negotiation. Use when changing v2 or v3 authentication, capabilities, relay-floor behavior, server-selected features, or game-start semantics.
---
...
[public-api-design](../public-api-design/SKILL.md) also counts the two v2 `GameStart`
codes). See
...
never computes who offers. See [public-api-design](../public-api-design/SKILL.md) for the
exhaustive-variant semver rules and the `TransportKind`-vs-`Transport`-trait
naming rule, and [crate-publishing](../crate-publishing/SKILL.md) for the version bump.
