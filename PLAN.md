...
hosted: open one breaking-change PR, pass every required check, obtain reviewer
approval, merge, and close #86. Token-binding-v2 remains a separate negotiated
