...
description: Configure and validate Signal Fish CI/CD safely. Use when editing workflows, dependency scanners, action references, check scripts, badges, caching, or cross-file CI invariants.
---
