...
!!! note "Published crate versus this guide"
    The stable crates.io release is **0.14.0**. This guide tracks the current
    ...
    [0.14.0 API docs](https://docs.rs/signal-fish-client/0.14.0/) for the
