---
name: shared-core-drivers
description: Keep async and polling client drivers behaviorally aligned through ClientCore. Use when changing commands, events, state, queues, shutdown, statistics, or driver-specific orchestration.
---
...
pending transport sends, bounded per-poll send/receive work, scheduling
