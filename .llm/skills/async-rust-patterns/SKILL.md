...
description: Apply Tokio and polling patterns used by Signal Fish. Use when changing runtime setup, task spawning, select loops, bounded channels, Send behavior, or async shutdown.
---
