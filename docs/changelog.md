...
> This changelog is also available at [CHANGELOG.md](https://github.com/Ambiguous-Interactive/signal-fish-client-rust/blob/main/CHANGELOG.md) in the repository root.
