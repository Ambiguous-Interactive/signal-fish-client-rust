...
description = "Framed-transport-agnostic Rust client for the Signal Fish multiplayer signaling protocol"
...
signal-fish-client = { version = "=0.13.0", path = ".", default-features = false }
```
