...
description: Build reliable source-scanning tests and scripts for Rust. Use when matching identifiers or syntax while accounting for comments, strings, raw strings, word boundaries, and recursive traversal.
---
