...
description: Write shell automation portable across GNU and BSD hosts. Use when editing repository shell scripts involving output, sed, find, arrays, temporary files, traps, or platform-specific commands.
---
...
- `../ci-configuration/SKILL.md` "Portable regex" section for additional context
- `../ci-configuration/SKILL.md` "SC2001" section for parameter expansion alternatives to `echo | sed`
