...
description: Add structured tracing without leaking sensitive data or adding noisy spans. Use when instrumenting client, transport, protocol, lifecycle, error, or performance paths.
---
