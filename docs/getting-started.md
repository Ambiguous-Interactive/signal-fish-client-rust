...
```toml
[dependencies]
signal-fish-client = { version = "0.2.3", default-features = false }
```
...
!!! note
    ...
    ```toml
    signal-fish-client = { version = "0.2.3", default-features = false, features = ["transport-websocket"] }
    ```
