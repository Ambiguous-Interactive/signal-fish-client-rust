---
name: doc-drift-validation
description: Prevent documentation from drifting from source configuration. Use when docs duplicate settings, feature flags, versions, commands, file lists, or other machine-verifiable facts.
---
