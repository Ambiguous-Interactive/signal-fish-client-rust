...
description: Format Signal Fish changelog entries consistently. Use when adding Unreleased items, release headings, comparison links, or category entries under Keep a Changelog conventions.
---
...
- Write for crate consumers and contributors affected by repository usability,
